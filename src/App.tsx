...
function App() {
  ...
  return (
    <main className="   flex flex-col  h-screen w-screen items-center max-h-screen container mx-auto py-4 px-10 gap-4  ">
      {/* <div className="   flex  h-full  flex-row items-center justify-center  "> */}
      <Header />
      <div className="flex flex-row justify-center h-full">
        <div className=" rounded-s-[20px] w-4/12 max-w-[410px] h-full   bg-background-header    lg:h-full   max-lg:justify-start   justify-center items-start flex p-10">
