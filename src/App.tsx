...
function App() {
  return (
    <main className="  relative flex justify-center h-screen w-screen items-center max-h-screen container mx-auto ">
      <div className="   flex  h-full w-full  flex-row items-start    max-md:flex-col max-md:items-center p-10 ">
        <div className=" rounded-s-[20px] w-full h-full  max-w-[400px] bg-background-header   max-md:mr-0   lg:h-full   max-lg:justify-start   justify-center items-start flex p-10">
        ...
        <div className=" rounded-e-[20px]  flex flex-col justify-between w-full border h-full px-10 py-10  text-left max-w-3xl   gap-4 max-h-full overflow-scroll ">
          ...
          <Text>
            I struggle to manage my DMs over LinkedIn/Instagram and have created
            this channel to connect with people who want to get in touch.
          </Text>
          <Text>
          ...
          <Text>
            ...
            to me for college-events since l've stopped doing that a while back.
          </Text>
